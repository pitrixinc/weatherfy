...
const Weather = () => {
  ...
  return (
    ...
    >
      <div className="max-w-screen-xl mx-auto bg-white bg-opacity-30 rounded-lg p-8 shadow-lg">
        ...
        <div className="text-lg mb-6 text-blue-600">Updated as of {new Date().toLocaleTimeString()}</div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
          {forecastList.map((forecast, index) => (
            <div key={index} className="bg-blue-700 p-4 rounded-lg text-center text-white shadow-lg bg-opacity-40">
              ...
              <div className="text-2xl md:text-6xl text-yellow-400 my-2 flex items-center justify-center">
                <WiCloudy />
              </div>
        ...
        <div className="mt-5">
          <h2 className="text-2xl font-bold mb-3">Weather News</h2>
          <div className="bg-white text-blue-500 p-5 rounded-lg">Intense heat wave persists for tens of millions...</div>
        </div>
      </div>
    </div>
  );
