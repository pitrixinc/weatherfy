    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
        <div className="bg-white p-8 rounded-lg shadow-lg">
          <h2 className="text-4xl font-semibold mb-4 text-blue-600">Personalized Weather Reports</h2>
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg">
          <h2 className="text-4xl font-semibold mb-4 text-blue-600">Severe Weather Alerts</h2>
          <p className="text-lg text-gray-700 mb-4">
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg">
          <h2 className="text-4xl font-semibold mb-4 text-blue-600">Climate Monitoring</h2>
          <p className="text-lg text-gray-700 mb-4">
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg">
          <h2 className="text-4xl font-semibold mb-4 text-blue-600">Agricultural Forecasting</h2>
          <p className="text-lg text-gray-700 mb-4">
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg">
          <h2 className="text-4xl font-semibold mb-4 text-blue-600">Marine Weather Services</h2>
          <p className="text-lg text-gray-700 mb-4">
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg">
          <h2 className="text-4xl font-semibold mb-4 text-blue-600">Aviation Weather Services</h2>
          <p className="text-lg text-gray-700 mb-4">
