...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  <div class="aspect-w-16 aspect-h-7">
    <img class="w-full object-cover rounded-xl h-[300px]" src="https://i0.wp.com/www.yesmagazine.org/wp-content/uploads/imports/1fe74cb08af74b39b5cada38382e9233.jpg?fit=1400%2C840&quality=90&ssl=1" alt="Image Description"/>
  </div>
  ...
  <div class="mt-5 lg:mt-16 grid lg:grid-cols-3 gap-8 lg:gap-12">
    <div class="lg:col-span-1">
      ...
      Explore real-time updates, severe weather alerts, daily forecasts, and custom reports tailored to your needs. Stay informed and plan ahead with precision and confidence.
      </p>
    </div>
